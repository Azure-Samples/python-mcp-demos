...
# Auth feature flags
echo "USE_ENTRA_PROXY=$(azd env get-value USE_ENTRA_PROXY)" >> "$ENV_FILE_PATH"
...
KEYCLOAK_MCP_SERVER_BASE_URL=$(azd env get-value KEYCLOAK_MCP_SERVER_BASE_URL 2>/dev/null || echo "")
echo "KEYCLOAK_MCP_SERVER_BASE_URL=${KEYCLOAK_MCP_SERVER_BASE_URL}" >> "$ENV_FILE_PATH"
